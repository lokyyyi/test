	...
	public static void main(String[] args) {
		try (
				DataOutputStream out = new DataOutputStream(new BufferedOutputStream(
						new FileOutputStream("src/ch2103/out-dataoutputstream.txt")));
		){
		...
		try (
				DataInputStream in = new DataInputStream(new BufferedInputStream(
						new FileInputStream("src/ch2103/out-dataoutputstream.txt")));
		){
		...
		try(
				ObjectOutputStream out = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("src/ch2103/out-objectoutputstream.txt")));
		){
		...
		try (
				ObjectInputStream in = new ObjectInputStream(new BufferedInputStream(
						new FileInputStream("src/ch2103/out-objectoutputstream.txt")));
		){
