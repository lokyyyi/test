...
public class Ex02Enum {
	...
	public static void main(String[] args) {
		...
		System.out.println("월급날의 요일을 숫자로 입력해 주세요 (일:1 ~토:7): ");
		int payDay1 = s.nextInt();
		System.out.println("보너스 받는 달을 숫자로 입력해주세요: ");
		int bonusMonth1 = s.nextInt();
		
		if (payDay1 > bonusMonth1)
			System.out.println("달과 월은 비교할 수 없으므로 잘못된 코드 입니다.");
		...
		case Day1.SUN:
			...
			break;
		case Day1.MON:
			System.out.println("월요일은 오후 3시에 입급됩니다.");
			break;
		}
		...
		System.out.println("보너스 받는 달을 숫자로 입려규ㅐ 주세요: ");
		...
		*/
		...
		/*if (payDay3 > bonusDay3)
			System.out.println("달과 월은 비교 할수 없으므로 잘못된 코드입니다.");
		*/
