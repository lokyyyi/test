...
public class Ex03TypCasting {
	...
	public static void main(String[]args) {
		...
		int i3 = 7;
		long l = i3;
		System.out.println("long은 int를 저장할 수 있습니다.: 1=" + 1);
		//i3 = l; //에러
		System.out.println("int는 long을 저장할 수 없습니다.");
		
		// int i4 = 100000000000L;
		// long 12 = 100000000000;   //에러
		long l2 = 100000000000L;
		System.out.println("long 12 = " + 12);
		
		float f2 = 12;
		System.out.printf("float f2 = %f%n", f2);
		double d3 = 12;
		System.out.printf("double de = %f%n", d3);
