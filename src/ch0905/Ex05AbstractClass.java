...
abstract class Book5 {
	...
	public abstract String getTitle();	//추상메소드(abstract method)
...
class Cart {
	...
	public void printBooks() {
		for (int i=0; i<books.length; i++) {
			if(books[i] == null)
				return;
			System.out.println(books[i].getTitle() + books[i].getPrice() +  books[i].getAuthor());
		}
	}
}
/*
