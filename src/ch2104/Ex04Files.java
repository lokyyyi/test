...
public class Ex04Files {
	...
	public static void main(String[] args)	{
		...
		Path p4 = Paths.get(projectDir).resolve(packagePath).resolve("file-newbufferedwriter.txt");
		...
		Path p5 = Paths.get(projectDir).resolve(packagePath).resolve("test7.txt");
		try {
			Files.createFile(p5);
		} catch (IOException e) {
			e.printStackTrace();
